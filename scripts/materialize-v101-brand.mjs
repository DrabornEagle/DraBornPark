...
const dkd_version=String(dkd_package.version||'1.0.3');
...
if(dkd_png.subarray(0,8).toString('hex')!==dkd_signature)throw new Error(`DraBornPark v${dkd_version} branding payload is not a valid PNG.`);
...
console.log(`DraBornPark v${dkd_version} branding ready • ${Math.round(dkd_png.length/1024)} KB • SHA-256 ${dkd_sha256.slice(0,12)}`);
