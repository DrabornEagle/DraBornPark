...
const dkd_logo=require('../../assets/branding/splash-icon.png');
  ...
  return <Animated.View pointerEvents="none" style={[dkd_styles.root,{opacity:dkd_enter}]}>
    <View style={dkd_styles.logoFrame}>
      <Animated.Image
        source={dkd_logo}
        resizeMode="contain"
        style={[dkd_styles.logo,{transform:[{translateY:dkd_float.interpolate({inputRange:[0,1],outputRange:[0,-5]})},{scale:dkd_pulse.interpolate({inputRange:[0,1],outputRange:[.985,1.008]})}]}]}
      />
    </View>
