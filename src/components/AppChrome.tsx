...
const s=StyleSheet.create({
  ...
  dockWrap:{paddingTop:12,paddingBottom:0},dockFloating:{position:'absolute',left:14,right:14,bottom:8,zIndex:40},dock:{minHeight:92,borderRadius:31,borderWidth:1,borderColor:palette.line,backgroundColor:palette.glassStrong,paddingHorizontal:5,paddingVertical:9,flexDirection:'row',alignItems:'center',overflow:'hidden'},dockItem:{flex:1,minHeight:70,borderRadius:22,borderWidth:1,borderColor:'transparent',alignItems:'center',justifyContent:'center',gap:5,paddingHorizontal:2},dockIcon:{width:46,height:42,borderRadius:16,borderWidth:1,borderColor:'transparent',alignItems:'center',justifyContent:'center'},activeDot:{position:'absolute',width:5,height:5,borderRadius:3,bottom:4},dockLabel:{fontSize:10,color:palette.muted2,fontWeight:'900',textAlign:'center'},
