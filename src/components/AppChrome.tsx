...
const s=StyleSheet.create({
  ...
  sectionHead:{marginTop:28,marginBottom:13,flexDirection:'row',alignItems:'flex-end',gap:10},sectionTitleRow:{flexDirection:'row',alignItems:'center',gap:10},sectionDot:{width:8,height:8,borderRadius:4},sectionTitle:{fontSize:type.sectionTitle,fontWeight:'900',color:palette.text,letterSpacing:-.6},sectionSub:{fontSize:type.caption,color:palette.muted,marginLeft:18,marginTop:5},sectionBadge:{borderWidth:1,borderRadius:999,paddingHorizontal:11,paddingVertical:8},sectionBadgeText:{fontSize:type.micro,fontWeight:'900'},
});