...
const groups:Group[]=[
  ...
  {title:'Hesap & Destek',caption:'Yasal, hesap ve üretim araçları',color:palette.blue,icon:'account-cog-outline',items:[
    ...
    {title:'Dış QR / NFC',subtitle:'Araç dışındaki kişinin web deneyimi',icon:'qrcode-scan',color:palette.cyan,demo:'public',keywords:'qr nfc dış web'},
...
const s=StyleSheet.create({
  ...
  hero:{minHeight:174,borderRadius:radius.xl,borderWidth:1,borderColor:`${palette.purple}55`,backgroundColor:`${palette.purple}10`,padding:20,flexDirection:'row',alignItems:'center',gap:16,...shadows.soft},heroBadge:{width:76,height:76,borderRadius:26,backgroundColor:palette.purple,alignItems:'center',justifyContent:'center'},heroKicker:{color:palette.purple,fontSize:type.micro,fontWeight:'900',letterSpacing:1.2},heroTitle:{color:palette.text,fontSize:27,fontWeight:'900',letterSpacing:-.75,marginTop:5},heroText:{color:palette.muted,fontSize:type.caption,lineHeight:20,marginTop:7},
  search:{height:64,borderRadius:22,borderWidth:1,borderColor:`${palette.cyan}42`,backgroundColor:palette.glassStrong,marginTop:14,paddingHorizontal:15,flexDirection:'row',alignItems:'center',gap:10,...shadows.soft},searchInput:{flex:1,color:palette.text,fontSize:type.body,paddingVertical:0},clear:{width:36,height:36,borderRadius:12,borderWidth:1,borderColor:palette.line,alignItems:'center',justifyContent:'center'},
  categoryRail:{marginTop:13},category:{width:146,minHeight:92,borderRadius:22,borderWidth:1,padding:13,justifyContent:'space-between'},categoryTitle:{color:palette.text,fontSize:type.caption,fontWeight:'900',marginTop:7},categoryCount:{color:palette.muted2,fontSize:type.micro,marginTop:3},items:{gap:11},
  ...
  reset:{minHeight:100,borderRadius:radius.lg,borderWidth:1,borderColor:`${palette.yellow}48`,backgroundColor:`${palette.yellow}0D`,padding:16,flexDirection:'row',alignItems:'center',gap:13,marginTop:28},resetTitle:{color:palette.text,fontSize:type.cardTitle,fontWeight:'900'},resetText:{color:palette.muted,fontSize:type.caption,lineHeight:20,marginTop:4},
});
