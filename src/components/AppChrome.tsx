...
const s=StyleSheet.create({
  ...
  dockWrap:{paddingTop:12,paddingBottom:0},dock:{minHeight:92,borderRadius:31,borderWidth:1,borderColor:palette.line,backgroundColor:palette.glassStrong,paddingHorizontal:7,paddingVertical:9,flexDirection:'row',alignItems:'center',overflow:'hidden'},dockTopSpectrum:{position:'absolute',left:18,right:18,top:0,height:3,flexDirection:'row',gap:3},dockBar:{flex:1,borderRadius:99},dockItem:{flex:1,minHeight:70,borderRadius:22,borderWidth:1,borderColor:'transparent',alignItems:'center',justifyContent:'center',gap:5},dockIcon:{width:46,height:42,borderRadius:16,borderWidth:1,borderColor:'transparent',alignItems:'center',justifyContent:'center'},activeDot:{position:'absolute',width:5,height:5,borderRadius:3,bottom:4},dockLabel:{fontSize:type.micro,color:palette.muted2,fontWeight:'900'},
